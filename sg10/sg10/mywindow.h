...
namespace sg{
	...
	public:
		...
		Cmywindow(Rect r, u32 style,HWND parent_hWnd,u16 *name) : CWindow( r, style, parent_hWnd, name),sf(surf,black),stmf(surf) {
			...
			imgs[0] = new sg::gr::CImg("u:/work/2023/rareprojcopy/visc/2023/gw_dither/pics/g1.png.ppm ");
			imgs[1] = new sg::gr::CImg("u:/work/2023/rareprojcopy/visc/2023/gw_dither/pics/colors.ppm ");
